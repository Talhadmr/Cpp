...
void Phonebook::add_to_book(void)
{
    ...
    {
        val[9] = '.';
        this->contacts[this->cont_num % 8].setname(val.substr(0,10));
    }
    val.clear();
    ...
    {
        val[10] = '.';
        this->contacts[this->cont_num % 8].setsurname(val.substr(0,10));
    }
    val.clear();
    ...
    {
        val[9] = '.';
        this->contacts[this->cont_num % 8].setnickname(val.substr(0,10));
    }
    val.clear();
    ...
    {
        val[9] = '.';
        this->contacts[this->cont_num % 8].setphone_number(val.substr(0,10));
    }
    val.clear();
    ...
    {
        val[10] = '.';
        this->contacts[this->cont_num % 8].setdarkest_secret(val.substr(0,10));
    }
    val.clear();
    this->cont_num++;
}
int Phonebook::table()
{
    ...
    i = 0;
    cout << "index     |Name      | Surname  | Nickname |"<< std::endl;
    cout << "--------------------------------------------"<< std::endl;
    while (i < this->cont_num && i < 8 )
    {
        cout<<"         " << i << "|";
        j = 0;
        len = 10 - this->contacts[i].getname().length();
        while(j < len)
        {
            cout << " ";
            j++;
        ...
        j = 0;
        len = 10 - this->contacts[i].getsurname().length();
        while(j < len)
        {
            cout << " ";
            j++;
        ...
        j = 0;
        len = 10 - this->contacts[i].getnickname().length();
        while(j < len)
        {
            cout << " ";
            j++;
        }
        cout <<this->contacts[i].getnickname() << "|" << std::endl;
        cout << "********************************************"<< std::endl;
